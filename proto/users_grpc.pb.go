...
const (
	...
	UsersService_CheckAuthToken_FullMethodName = "/UsersService/CheckAuthToken"
)
...
func (c *usersServiceClient) CheckAuthToken(ctx context.Context, in *CheckAuthTokenRequest, opts ...grpc.CallOption) (*CheckAuthTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckAuthTokenResponse)
	err := c.cc.Invoke(ctx, UsersService_CheckAuthToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUsersServiceServer) CheckAuthToken(context.Context, *CheckAuthTokenRequest) (*CheckAuthTokenResponse, error) {
...
func _UsersService_CheckAuthToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckAuthTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServiceServer).CheckAuthToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsersService_CheckAuthToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).CheckAuthToken(ctx, req.(*CheckAuthTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UsersService_CheckAuthToken_Handler,
		},
	},
